...
def test_tv_click_190():
    with sync_playwright() as p:
        ...
        # Click TV segment at (190, 219)
        print("Clicking TV toggle segment at (190, 219)...", flush=True)
        page.mouse.click(190, 219)
        time.sleep(2.5)

        shot = os.path.join(SCREENSHOT_DIR, "00_tv_active_190.png")
