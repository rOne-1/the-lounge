...
def test_tv_click():
    with sync_playwright() as p:
        ...
        # Click TV segment at (310, 215)
        print("Clicking TV toggle segment at (310, 215)...", flush=True)
        page.mouse.click(310, 215)
        time.sleep(2.5)

        shot = os.path.join(SCREENSHOT_DIR, "00_tv_active.png")
