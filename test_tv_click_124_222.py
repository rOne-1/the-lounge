...
def test_tv_click_124_222():
    with sync_playwright() as p:
        ...
        # Click TV segment at (124, 222)
        print("Clicking TV toggle segment at (124, 222)...", flush=True)
        page.mouse.click(124, 222)
        time.sleep(2.5)

        shot = os.path.join(SCREENSHOT_DIR, "00_tv_active_124_222.png")
