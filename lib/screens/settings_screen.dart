...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
        ...
        children: [
          Container(
            ...
            child: SafeArea(
              child: Column(
                children: [
                  // BETA3-SETTINGS-1: header now shows current theme + active
                  // Hall, matching the locked luxury-redesign mockup's
                  // "{Theme} · your space" subtitle pattern.
                  Padding(
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                '${ambiance.displayName} · ${activeHall.name}',
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                  ...
                  Expanded(
                    child: ListView(
                      ...
                      children: [
                        // Section 1: Ambiance -- BETA3-SETTINGS-1: card-based
                        // theme selector (visual preview swatch + name + status)
                        // replacing the compact segmented control, matching the
                        // locked luxury-redesign mockup.
                        ...
                        SizedBox(
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) => _buildThemeCard(
                              context,
                              allThemes[index],
                              isSelected: allThemes[index].id == ambiance.id,
                            ),
                          ),
                        ),
                          ...
                          child: Column(
                            children: [
                              ListTile(
                                ...
                                onTap: () async {
                                  ...
                                  final jsonString =
                                    ...
                                    halls:
                                        storageService.loadAllHallsSync(prefs),
                                    activeHallId:
                                        storageService.getActiveHallId(prefs),
                                    themeId: ambiance.id,
                                  );
                                  try {
                                      ...
                                      shouldImport =
                                          await LoungeDialog.show<bool>(
                                                ...
                                                actions: [
                                                  ...
                                                  LoungeDialogAction(
                                                    key: const ValueKey(
                                                        'confirm_overwrite_button'),
                                                    label: 'Overwrite',
                                                    style:
                                                        LoungeDialogActionStyle
                                                            .primary,
                                                    onPressed: () =>
                                                        Navigator.of(context)
                                                            .pop(true),
                              ...
                              ListTile(
                                ...
                                onTap: () async {
                                  final shouldReset = await LoungeDialog.show<
                                          bool>(
                                        context,
                                ...
                                return Column(
                                  ...
                                  children: [
                                    ...
                                    if (tracker.failureRecords.isNotEmpty) ...[
                                      ...
                                      PressableScale(
                                        key: const ValueKey(
                                            'copy_api_failures_button'),
                                        onTap: () {
                                          final jsonStr = tracker
                                              .exportFailuresJsonPretty();
                                          Clipboard.setData(
          ...
          if (_busyMessage != null)
            _BlockingLoadingOverlay(message: _busyMessage!),
        ],
      ),
    );
  }
  ...
  Widget _buildCard(BuildContext context, Color bgColor, bool isDark,
  ...
  /// BETA3-SETTINGS-1: one ambiance theme as a tappable preview card --
  /// swatch (the theme's own background gradient + its two glow-accent
  /// dots), name, and status, replacing the old compact segmented control.
    ...
    return PressableScale(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isSelected ? theme.colors.acc : colors.lineRgba,
          ...
          children: [
            ClipRRect(
              ...
              child: SizedBox(
                ...
                child: DecoratedBox(
                  decoration: theme.colors.background,
                  child: Padding(
                    ...
                    child: Align(
                      ...
                      child: Row(
                        ...
                        children: [
                          _themeDot(theme.colors.glow1),
                          const SizedBox(width: 4),
                          _themeDot(theme.colors.glow2),
                        ],
                      ),
                    ),
                  ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: AppThemes.safeGeist(
                      fontSize: 11,
                      color: isSelected ? theme.colors.acc : colors.sub,
                    ),
                  ),
                ],
              ),
    ...
    return Opacity(
      ...
      child: ListTile(
        ...
        trailing: IgnorePointer(
          child:
              Switch(value: false, onChanged: null, activeThumbColor: accColor),
        ),
        onTap: () => LoungeToast.show(
          context,
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  height: 1.2,
                  color:
                      context.ambianceColors.lineRgba.withValues(alpha: 0.65),
                ),
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: CircularProgressIndicator(
                        strokeWidth: 2.5,
                        valueColor:
                            AlwaysStoppedAnimation<Color>(ambianceColors.acc),
                      ),
                    ),
                  ),
                  const SizedBox(height: 24),
