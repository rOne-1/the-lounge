...
def test_tv_click_180():
    with sync_playwright() as p:
        ...
        # Click TV segment at (180, 215)
        print("Clicking TV toggle segment at (180, 215)...", flush=True)
        page.mouse.click(180, 215)
        time.sleep(2.5)

        shot = os.path.join(SCREENSHOT_DIR, "00_tv_active_180.png")
